...
module NIST_test_averaged ( main) where
...
main = 
  do
    ...
    [valency_s,breadth_s,offset_s,model] <- getArgs
    let (valency,breadth,offset) = (read valency_s, read breadth_s, read offset_s)
