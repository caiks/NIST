...
main = 
  do
    ...
    s <- BL.readFile "./NIST_model20.json"
    ...
    let ff1 = fframe (refr1 2) $ dfnul uu1 (dfred uu1 df1 hr) 1
    ...
    let gg1 = foldl funion fudEmpty [fframe (refr2 x y) ff1 | x <- [1,7,14], y <- [1,7,14]]
