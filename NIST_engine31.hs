...
main = 
  do
    ...
    s <- BL.readFile "./NIST_model30.json"
    ...
    let gg1 = foldl funion fudEmpty [fframe (refr2 x y) ff1 | (x,y) <- [(1,5),(1,9),(5,1),(5,5),(5,9),(5,13),(9,1),(9,5),(9,9),(9,13),(13,5),(13,9)]]
